...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PB_DPAD_UP_Pin PB_DPAD_DOWN_Pin PB_DPAD_LEFT_Pin */
  GPIO_InitStruct.Pin = PB_DPAD_UP_Pin|PB_DPAD_DOWN_Pin|PB_DPAD_LEFT_Pin;
  ...
  /*Configure GPIO pins : PB_SELECT_Pin PB_START_Pin */
  GPIO_InitStruct.Pin = PB_SELECT_Pin|PB_START_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PB_DPAD_RIGHT_Pin PB_A_Pin PB_B_Pin */
  GPIO_InitStruct.Pin = PB_DPAD_RIGHT_Pin|PB_A_Pin|PB_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
