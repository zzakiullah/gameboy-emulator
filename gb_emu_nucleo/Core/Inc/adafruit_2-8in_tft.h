...
#ifndef INC_ADAFRUIT_2_8IN_TFT_H_
#define INC_ADAFRUIT_2_8IN_TFT_H_
...
HAL_StatusTypeDef Adafruit28TFT_Reset(void);

HAL_StatusTypeDef Adafruit28TFT_DrawPixel(int16_t x, int16_t y, uint16_t color);
HAL_StatusTypeDef Adafruit28TFT_Fill(uint16_t color);
HAL_StatusTypeDef Adafruit28TFT_Flood(uint16_t color, uint32_t len);

HAL_StatusTypeDef Adafruit28TFT_SetRegisters8(uint8_t *ptr, uint8_t n);
HAL_StatusTypeDef Adafruit28TFT_SetRegisters16(uint8_t *ptr, uint16_t n);

HAL_StatusTypeDef Adafruit28TFT_Write8(uint8_t value);
HAL_StatusTypeDef Adafruit28TFT_Read8(void);
HAL_StatusTypeDef Adafruit28TFT_SetWriteDir(void);
HAL_StatusTypeDef Adafruit28TFT_SetReadDir(void);
HAL_StatusTypeDef Adafruit28TFT_SetLR(void);

HAL_StatusTypeDef Adafruit28TFT_WriteRegister8(uint8_t address, uint8_t data);
HAL_StatusTypeDef Adafruit28TFT_WriteRegister16(uint8_t address, uint16_t data);
HAL_StatusTypeDef Adafruit28TFT_WriteRegister24(uint8_t address, uint24_t data);
HAL_StatusTypeDef Adafruit28TFT_WriteRegister32(uint8_t address, uint32_t data);

HAL_StatusTypeDef Adafruit28TFT_WriteRegisterPair(uint8_t addressHigh, uint8_t addressLow, uint16_t data);

#endif /* INC_ADAFRUIT_2_8IN_TFT_H_ */
