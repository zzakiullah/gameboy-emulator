...
#define ILI9341_RD_ACTIVE	HAL_GPIO_WritePin(SCREEN_RD_GPIO_Port, SCREEN_RD_Pin, GPIO_PIN_RESET)
#define ILI9341_RD_IDLE 	HAL_GPIO_WritePin(SCREEN_RD_GPIO_Port, SCREEN_RD_Pin, GPIO_PIN_SET)
#define ILI9341_WR_ACTIVE 	HAL_GPIO_WritePin(SCREEN_WR_GPIO_Port, SCREEN_WR_Pin, GPIO_PIN_RESET)
#define ILI9341_WR_IDLE 	HAL_GPIO_WritePin(SCREEN_WR_GPIO_Port, SCREEN_WR_Pin, GPIO_PIN_SET)
#define ILI9341_CD_COMMAND 	HAL_GPIO_WritePin(SCREEN_CD_GPIO_Port, SCREEN_CD_Pin, GPIO_PIN_RESET)
#define ILI9341_CD_DATA 	HAL_GPIO_WritePin(SCREEN_CD_GPIO_Port, SCREEN_CD_Pin, GPIO_PIN_SET)
#define ILI9341_CS_ACTIVE 	HAL_GPIO_WritePin(SCREEN_CS_GPIO_Port, SCREEN_CS_Pin, GPIO_PIN_RESET)
#define ILI9341_CS_IDLE 	HAL_GPIO_WritePin(SCREEN_CS_GPIO_Port, SCREEN_CS_Pin, GPIO_PIN_SET)
